    ...
    <>
      <div className="columns top">
        <div className="left-part">
          <h2 className="title red typo">
            <Title item={item} naming={item.title} />
          </h2>
          <p>
            <Title item={item} naming={item.location} />
          </p>
          <ul>
        ...
        <div className="right-part">
          <div className="columns plus-center">
      ...
      <div className="columns space">
        <div className="left-part">
          <DropDown title="Description" content={item.description} customClassName="title-bar" />
        </div>
        <div className="right-part">
          <DropDown
            title="Equipements"
